...
import clinic from './clinic2.avif';
import './about.css';
  ...
  return (
      <div id='aboutus'>
          ...
          <div className='clinic-info'>
                  <img src={clinic} width='600' height='300' alt='clinic' className='clinic-img' />
